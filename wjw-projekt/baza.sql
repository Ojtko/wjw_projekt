...
--
-- Host: 127.0.0.1
-- Czas generowania: 20 Lis 2025, 12:08
...
INSERT INTO `ekspertyzy` (`id`, `message_id`, `klients_id`, `wycena`, `status`, `termin`) VALUES
(1, 1, 1, '1200.00', 'oczekuje', NULL),
(2, 2, 2, '1500.00', 'w trakcie', '2025-12-05'),
(3, 3, 3, '2100.00', 'wykonane', '2025-12-12'),
(4, 4, 4, '1000.00', 'wykonane', '2025-12-20'),
(5, 5, 5, '950.00', 'w trakcie', '2025-12-25'),
(6, 14, 7, '0.00', 'oczekuje', NULL);
...
(7, 'Imie Nazwisko', 'mail@email.com');
...
(14, 'Imie Nazwisko', 'mail@email.com', 'Adres 12, Miasto', 'Tresc wiadomosci', '2025-11-20 09:57:29');
